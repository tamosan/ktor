...
fun HttpMessageBuilder.contentType(): ContentType = headers[HttpHeaders.ContentType]?.let { ContentType.parse(it) } ?: ContentType.Any
...
fun HttpMessage.contentType(): ContentType = headers[HttpHeaders.ContentType]?.let { ContentType.parse(it) } ?: ContentType.Any
...
fun HttpMessageBuilder.setCookies(): List<Cookie> =
