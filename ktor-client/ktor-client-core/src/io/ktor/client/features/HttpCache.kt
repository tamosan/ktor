...
//
//    private fun load(request: HttpRequestBuilder): Any? {
...
//            }
//
//            scope.responsePipeline.intercept(HttpResponsePipeline.After) { (type, response) ->
...
//}
//
//class NotFoundInCacheException(val request: BaseHttpRequest) : Exception()